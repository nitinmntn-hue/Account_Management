      ...
      <div className="grid lg:grid-cols-3 gap-6 mt-8">
        ...
        <div className="bg-white rounded-xl shadow p-5">
          ...
          <div className="grid gap-3">
            ...
            <button className="bg-green-500 text-white rounded-lg py-3">
              + Add Income
            </button>

            <button className="bg-red-500 text-white rounded-lg py-3">
              + Add Expense
            </button>

            <button className="bg-blue-500 text-white rounded-lg py-3">
              Cash Deposit
            </button>
            ...
            <button className="bg-purple-500 text-white rounded-lg py-3">
              Contra Voucher
            </button>

            <button className="bg-slate-800 text-white rounded-lg py-3">
              View Reports
            </button>
